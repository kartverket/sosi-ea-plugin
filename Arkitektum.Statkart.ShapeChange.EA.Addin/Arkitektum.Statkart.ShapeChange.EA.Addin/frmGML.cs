...
namespace Arkitektum.Statkart.ShapeChange.EA.Addin
{
    public partial class frmGML : Form
    {
        ...
        public void SetRepository(Repository newrepository)
        {
            ...
            txtShapechangeJar.Text = dlldir + "\\ShapeChange.jar";
        ...
        private void WriteConfig(string fil, string eadirectory, string shapechangeconfig, string skjemanavn, string encodingRule, string dokformat)
        {
            ...
            textWriter.WriteEndAttribute();
            textWriter.WriteStartAttribute("value");
            textWriter.WriteString("alwaysVoid,neverVoid,Code,lastChange,appliesTo,SOSI_navn,NVDB_ID,SOSI_verdi");
            textWriter.WriteEndAttribute();
            textWriter.WriteEndElement();
            ...
            textWriter.WriteStartElement("targets");
                ...
                textWriter.WriteStartElement("include", "http://www.w3.org/2001/XInclude");
                textWriter.WriteAttributeString("href", "http://www.arkitektum.no/files/sosi/StandardRules.xml");
                textWriter.WriteEndElement();
        ...
        {
            System.Diagnostics.Process.Start("http://www.arkitektum.no/opplaering/enterprise-architect-shapechange");
        }
